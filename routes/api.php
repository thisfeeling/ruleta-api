...
Route::middleware(['auth:sanctum', 'sanctum.token_expired'])->group(function () {
    ...
    // Instructions
    Route::post('/games/{game}/instructions/read', [\App\Http\Controllers\InstructionController::class, 'markAsRead']);
    Route::get('/games/{game}/instructions/status', [\App\Http\Controllers\InstructionController::class, 'getStatus']);
    Route::post('/games/{game}/instructions/force-complete', [\App\Http\Controllers\InstructionController::class, 'forceComplete'])->middleware('supervisor');
    ...
    // Scoreboard
    Route::get('/shows/{show}/scoreboard', [\App\Http\Controllers\ScoreboardController::class, 'show']);
    Route::get('/shows/{show}/scoreboard/top', [\App\Http\Controllers\ScoreboardController::class, 'top']);
    Route::get('/scoreboard/me', [\App\Http\Controllers\ScoreboardController::class, 'player']);
});
